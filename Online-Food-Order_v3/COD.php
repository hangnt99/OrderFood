...
?>
        ...
        <div class="container">
          <div class="jumbotron">
            <h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> Đơn hàng thanh toán thành công.</h1>
          </div>
        </div>
        <br>

<h2 class="text-center"> Cảm ơn bạn đã đặt hàng tại Le Cafe'!</h2>
